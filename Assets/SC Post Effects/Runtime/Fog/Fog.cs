...
namespace SCPE
{
    [PostProcess(typeof(FogRenderer), PostProcessEvent.BeforeTransparent, "SC Post Effects/Environment/Screen-Space Fog")]
    [Serializable]
    public sealed class Fog : PostProcessEffectSettings
    {
        ...
        [Header("Skybox")]
        public Vector2Parameter horizonMinMax = new Vector2Parameter { value = new Vector2(0,1)};
        ...
        [Range(1f, 100f)]
        public FloatParameter lightExponent = new FloatParameter { value = 8f };
        ...
        {
            Shader.SetGlobalInt("_SCPEFogEnabled", enabled.value ? 1 : 0);
